    ...
    <div class="board-info">
      <div class="board-title">
        <div class="main-title">
          <h2 @click="setToEdit('title')" v-show="!isEditingState || currEditedTag !== 'title'">
            {{ board.title }}
          </h2>
          <input
            ref="title"
          ...
          <el-table :data="members">
            <el-table-column width="45">
              <template slot-scope="scope">
                <avatar :size="30" :src="scope.row.imgUrl" :username="scope.row.fullname"></avatar>
              </template>
            </el-table-column>
            <el-table-column property="fullname" label="Fullname"></el-table-column>
            <el-table-column>
              <template slot-scope="scope">
                <el-button size="mini" @click="updateTag(scope.$index, scope.row)">Edit</el-button>
                <el-button size="mini" type="danger" @click="updateTag(scope.$index, scope.row)"
                  >Delete</el-button
                >
              </template>
            </el-table-column>
