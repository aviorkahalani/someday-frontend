  ...
  <div class="home">
    <section class="header">
      <div id="nav">
        ...
        <router-link :to="`/board/61d6d0ff33af5957e8008f71`">Boards</router-link>
      ...
      <section class="title">
        <div class="home-desc animate__animated animate__slideInLeft animate__fast">
          ...
          <p>
            Work OS for better collaboration, organization, and efficiency in all their work.
          </p>
    ...
    <section class="details">
      <div class="manage">
        ...
        <div class="manage-desc">
          ...
          <p>
            Collaborate with team members across platforms, track progress and engage in real time,
      ...
      <div class="set-up">
        <div class="manage-desc">
          ...
          <p>
            Get started fast with hundreds of visual and customizable templates - or create your
            own.
          </p>
          <p>
            You dont need an account to try out Someday. It is free to use for as long as you like.
          </p>
        </div>
        <div>
          <img
...
export default {
  ...
  methods: {
    start() {
      this.$store.dispatch({ type: 'login', userCreds: this.userCreds }).then((user) => {
        console.log('user :>> ', user)
        this.$router.push(`board/61d6d0ff33af5957e8008f71`)
      })
    },
    handleClose() {
